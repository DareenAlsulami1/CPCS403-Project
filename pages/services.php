...
<body>
    ...
    <div class="menu-feedback-section">
        ...
        <div class="image-content">
            <a href="menu.html"><img src="../images/menu_board.png" alt="menu board"></a>
        </div>
    </div>

    <div class="working-hours-section">
        <div class="image-content">
            <a href="schedule.html"><img src="../images/working_hours_section.png" alt="menu board"> </a>
        </div>
        <div class="text-content">
    ...
    <div class="menu-feedback-section">
        ...
        <div class="image-content">
            <a href="feedback.html"> <img src="../images/feedback_section.png" alt="menu board"> </a>
        </div>
    </div>
